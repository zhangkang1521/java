...
public class TransferInvestorsReportExcel {
    ...
    public void execute(Context context, ParameterParser params,Navigator nav) {
    	PageResult<InvestorsReportDO> result = investQueryService.queryTransferInvestorsReport( new PageCondition(0, investQueryService.queryCountTransferInvestorsReport()));
    	
		List<String> fieldName=Arrays.asList(new String[]{"项目代码","原始项目代码","投资人用户名","姓名","身份证号","手机号","邮箱","推荐人","投资时间","投资金额","应收利息","已收利息","已收本金","是否转让","是否结清"});
