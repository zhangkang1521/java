...
public class UnFreezeBgRetUrlAction {
	 private final static Logger logger = LoggerFactory.getLogger(UnFreezeBgRetUrlAction.class);
	    @Resource
	    ...
	    public void execute(Context context, ParameterParser params) {
			...
			HuiFuData  data=payMent.unfreezehResult(resq);
			if (!data.getRespCode().equals("000")) {
				logger.warn("解冻回调错误");
				System.out.println("解冻回调错误");
			}
			try {
