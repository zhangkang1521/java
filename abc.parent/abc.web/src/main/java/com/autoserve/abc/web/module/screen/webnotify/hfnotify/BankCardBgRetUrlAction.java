...
public class BankCardBgRetUrlAction {
	...
	public void execute(Context context,ParameterParser params,Navigator nav){
		...
		if (!data.getRespCode().equals("000")) {
	    	...
	    	//bankInfo.setBankName(data.getOpenAcctId());
			...
			bankInfoSer.createBankInfo(bankInfo);
...
//		StationLetterService sLetterService=new StationLetterServiceImpl();
//		sLetterService.sendMail(2, "", wscustuser.getId(), "用户绑卡成功，卡号是"+data.getOpenAcctId());
