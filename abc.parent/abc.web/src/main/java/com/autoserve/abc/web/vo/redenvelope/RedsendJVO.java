package com.autoserve.abc.web.vo.redenvelope;
...
/**
 * 类RedsendJVO.java的实现描述：红包 VO 实体类
 * 
 * @author lipeng 2014年12月29日 上午10:42:43
 */
public class RedsendJVO {
    /**
    ...
    public String getRsStarttime() {
        return rsStarttime;
    }

    public void setRsStarttime(String rsStarttime) {
    ...
    public String getRsSendtime() {
        return rsSendtime;
    }

    public void setRsSendtime(String rsSendtime) {
        this.rsSendtime = rsSendtime;
    }

    public String getRuUsetime() {
        return ruUsetime;
    }

    public void setRuUsetime(String ruUsetime) {
