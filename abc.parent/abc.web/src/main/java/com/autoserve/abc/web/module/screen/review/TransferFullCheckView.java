...
/**
 * @author yuqing.zheng Created on 2015-01-16,00:06
 */
public class TransferFullCheckView {
    private static final Logger logger = LoggerFactory.getLogger(TransferFullCheckView.class);
