...
public class UserHouseVO {
    /**
     * 主键id abc_user_house.uh_id
     */
    private Integer    uhId;

    /**
     * 用户id abc_user_house.uh_user_id
     */
    private Integer    uhUserId;

    /**
     * 房产地址 abc_user_house.uh_address
     */
    private String     uhAddress;

    /**
     * 建筑面积 abc_user_house.uh_area
     */
    private BigDecimal uhArea;

    /**
     * 供款状况 abc_user_house.uh_pay_state
     */
    private String     uhPayState;

    /**
     * 建筑日期 abc_user_house.uh_date
     */
    private String     uhDate;

    /**
     * 所有权1 abc_user_house.uh_owner_one
     */
    private String     uhOwnerOne;

    /**
     * 所有权1的份额 abc_user_house.uh_share_one
     */
    private BigDecimal uhShareOne;

    /**
     * 所有权2 abc_user_house.uh_owner_two
     */
    private String     uhOwnerTwo;

    /**
     * 所有权2的份额 abc_user_house.uh_share_two
     */
    private BigDecimal uhShareTwo;

    /**
     * 贷款年限 abc_user_house.uh_loan_period
     */
    private Integer    uhLoanPeriod;

    /**
     * 每月供款 abc_user_house.uh_month_pay
     */
    private BigDecimal uhMonthPay;

    /**
     * 尚欠供款余额 abc_user_house.uh_sett_pay
     */
    private BigDecimal uhSettPay;

    /**
     * 按揭银行 abc_user_house.uh_pay_bank
     */
