...
public class AddFundApply {
    ...
    public JsonBaseVO execute(ParameterParser param){
    	...
    	BaseResult result = fundApplyService.createFundApply(FundApplyVOConvert.toFundApply(fundApplyVO), fundProfitList!=null?FundProfitVOConvert.convertEntityList(fundProfitList):null);
