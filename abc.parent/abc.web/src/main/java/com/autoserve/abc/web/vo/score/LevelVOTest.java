 ...
 */
public class LevelVOTest {
    private Integer    sys_level_id;

    private String     sys_level_name;

    private String sys_min_score;

    private String sys_max_score;
    ...
    public String getSys_min_score() {
        return sys_min_score;
    }

    public void setSys_min_score(String sys_min_score) {
        this.sys_min_score = sys_min_score;
    }

    public String getSys_max_score() {
        return sys_max_score;
    }

    public void setSys_max_score(String sys_max_score) {
