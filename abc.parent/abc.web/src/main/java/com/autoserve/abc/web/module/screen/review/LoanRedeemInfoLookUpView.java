...
/**
 * @author yuqing.zheng Created on 2014-12-11,15:47
 */
public class LoanRedeemInfoLookUpView {
    private static final Logger logger = LoggerFactory.getLogger(LoanRedeemInfoLookUpView.class);
