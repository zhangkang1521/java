 ...
 * 机构充值查询
 * 
 * @author liuwei 2014年12月24日 下午3:56:33
 */
public class ActionGuarRechargeListView {

    @Resource
    private RechargeService RechargeService;

    private static Logger   logger = LoggerFactory.getLogger(ActionGuarRechargeListView.class);
    ...
    public JsonPageVO<TocashRecordVO> execute(ParameterParser params, @Param("page") int page, @Param("rows") int rows) {
        ...
        PageResult<TocashRecordJDO> result = this.RechargeService.queryEmpRecharge(tocashRecordJDO, pageCondition,
                startDate, endDate);
