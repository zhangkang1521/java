...
public class DateUtil extends DateUtils {
	...
	// public static final String[] DAY_OF_WEEK_SHORT_NAME = new String[] { "日",
	// "一", "二", "三", "四", "五", "六" };
	// public static final String[] DAY_OF_WEEK_SHORT_NAME_EN = new String[] {
	...
	// if (locale == null || "zh".equals(locale.getLanguage()) ||
	// "zh_cn".equals(locale.getLanguage())) {
	// sb.append("（").append(DAY_OF_WEEK_SHORT_NAME[calendar.get(Calendar.DAY_OF_WEEK)
	// - 1]).append("）");
	// } else {
	// sb.append("(").append(DAY_OF_WEEK_SHORT_NAME_EN[calendar.get(Calendar.DAY_OF_WEEK)
	// - 1]).append(")");
	// }
	//
	// return sb.toString();
	...
	public static Date parse(String date) throws ParseException {
		...
		SimpleDateFormat format = new SimpleDateFormat(DATE_LONG_TIME_FORMAT,
				Locale.US);
	...
	//
	// private static Map<Integer, String[]> weekdayNames =
	// buildWeekdayNamesTable();
	// private static Map<Integer, String[]> monthNames =
	// buildMonthNamesTable();
	//
	// private static Map<Integer, String[]> buildWeekdayNamesTable() {
	// Map<Integer, String[]> m = new HashMap<Integer, String[]>();
	//
	// m.put(Integer.valueOf(Calendar.SUNDAY), new String[] {
	// "display.date.week.full.sunday",
	// "display.date.week.short.sunday", "display.date.week.shortest.sunday" });
	// m.put(Integer.valueOf(Calendar.MONDAY), new String[] {
	// "display.date.week.full.monday",
	// "display.date.week.short.monday", "display.date.week.shortest.monday" });
	// m.put(Integer.valueOf(Calendar.TUESDAY), new String[] {
	// "display.date.week.full.tuesday",
	// "display.date.week.short.tuesday", "display.date.week.shortest.tuesday"
	// });
	// m.put(Integer.valueOf(Calendar.WEDNESDAY), new String[] {
	// "display.date.week.full.wednesday",
	// "display.date.week.short.wednesday",
	// "display.date.week.shortest.wednesday" });
	// m.put(Integer.valueOf(Calendar.THURSDAY), new String[] {
	// "display.date.week.full.thursday",
	// "display.date.week.short.thursday", "display.date.week.shortest.thursday"
	// });
	// m.put(Integer.valueOf(Calendar.FRIDAY), new String[] {
	// "display.date.week.full.friday",
	// "display.date.week.short.friday", "display.date.week.shortest.friday" });
	// m.put(Integer.valueOf(Calendar.SATURDAY), new String[] {
	// "display.date.week.full.saturday",
	...
	// Map<Integer, String[]> m = new HashMap<Integer, String[]>();
	//
	// m.put(Integer.valueOf(Calendar.JANUARY), new String[] {
	// "display.date.month.full.january",
	// "display.date.month.short.january", "display.date.month.shortest.january"
	// });
	// m.put(Integer.valueOf(Calendar.FEBRUARY), new String[] {
	// "display.date.month.full.february",
	// "display.date.month.short.february",
	// "display.date.month.shortest.february" });
	// m.put(Integer.valueOf(Calendar.MARCH), new String[] {
	// "display.date.month.full.march",
	// "display.date.month.short.march", "display.date.month.shortest.march" });
	// m.put(Integer.valueOf(Calendar.APRIL), new String[] {
	// "display.date.month.full.april",
	// "display.date.month.short.april", "display.date.month.shortest.april" });
	// m.put(Integer.valueOf(Calendar.MAY), new String[] {
	// "display.date.month.full.may",
	// "display.date.month.short.may", "display.date.month.shortest.may" });
	// m.put(Integer.valueOf(Calendar.JUNE), new String[] {
	// "display.date.month.full.june",
	// "display.date.month.short.june", "display.date.month.shortest.june" });
	// m.put(Integer.valueOf(Calendar.JULY), new String[] {
	// "display.date.month.full.july",
	// "display.date.month.short.july", "display.date.month.shortest.july" });
	// m.put(Integer.valueOf(Calendar.AUGUST), new String[] {
	// "display.date.month.full.august",
	// "display.date.month.short.august", "display.date.month.shortest.august"
	// });
	// m.put(Integer.valueOf(Calendar.SEPTEMBER), new String[] {
	// "display.date.month.full.september",
	// "display.date.month.short.september",
	// "display.date.month.shortest.september" });
	// m.put(Integer.valueOf(Calendar.OCTOBER), new String[] {
	// "display.date.month.full.october",
	// "display.date.month.short.october", "display.date.month.shortest.october"
	// });
	// m.put(Integer.valueOf(Calendar.NOVEMBER), new String[] {
	// "display.date.month.full.november",
	// "display.date.month.short.november",
	// "display.date.month.shortest.november" });
	// m.put(Integer.valueOf(Calendar.DECEMBER), new String[] {
	// "display.date.month.full.december",
	// "display.date.month.short.december",
	 ...
	 * @return
	 */
	public static boolean validDateAfterToday(String dateSource,
			String dateFormat) {
		boolean result = false;
		if (StringUtils.isEmpty(dateSource)) {
			return false;
