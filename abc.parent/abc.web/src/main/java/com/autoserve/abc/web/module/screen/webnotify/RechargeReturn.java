    ...
    public void execute(Context context, Navigator nav, ParameterParser params) {
        ...
        try {
            if (ResultCode.equals("88")) {
                ...
                nav.redirectToLocation("/moneyReturnManage/rechangeReturn?Message=88&status=cz");
            } else {
                nav.redirectToLocation("/moneyReturnManage/rechangeReturn?Message=77&status=cz");
            }
        } catch (Exception e) {
