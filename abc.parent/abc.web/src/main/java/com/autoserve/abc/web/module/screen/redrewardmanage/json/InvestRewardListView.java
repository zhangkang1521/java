 ...
 */
public class InvestRewardListView {
    private static Logger  logger = LoggerFactory.getLogger(InvestRewardListView.class);
            ...
            try {
                ...
                for (Object item : itemsArray) {
                    ...
                    //到期日期结束时间
                        ...
                        redSearchDO.setRsState(Integer.valueOf(value));
                    }
                }
            } catch (Exception e) {
                logger.error("红包信息－投资返送红包－搜索查询 查询参数解析出错", e);
            }
        }
