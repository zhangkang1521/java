...
/**
 * @author RJQ 2014/12/3 21:24.
 */
public class EnableEmployee {
    @Resource
    ...
    public JsonBaseVO execute(@Param("empId") int empId) {
        BaseResult result = employeeService.enableEmployee(empId);
        ...
        operateLogDO.setOlContent("启用了ID为" + empId + "的管理员");//具体操作内容
