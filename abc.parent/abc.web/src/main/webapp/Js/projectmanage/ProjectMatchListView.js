...
$(function () {
    ...
    $("#MatchingOrg").click(MyAction.MatchingOrg);
...
var MyAction = {
    Init: function () {
        $("#ProjectMatchingGrid").datagrid({
            method:"GET",
            url: "/Demo/Json/P2PProjectMatchingList.json",
            ...
            { field: "loan_use", title: "借款用途", width: 100, align: "center" },
            { field: "pay_type", title: "还款方式", width: 100, align: "center" },
            { field: "guar_gov", title: "匹配机构", width: 150, align: "center" },
            { field: "match_state", title: "匹配状态", width: 100, align: "center" }
            ]],
            pagination: true,
            singleSelect: true
        })
        var p = $('#ProjectMatchingGrid').datagrid('getPager');
        $(p).pagination({
            pageSize: 10,
    ...
    MatchingOrg: function () {
        ...
        var Dialog = $.hDialog({
            href: "/P2PProjectManage/OrgMatchAddView",
            iconCls: 'icon-add',
            title: "匹配机构",
    ...
    LookUp: function () {
        ...
        var Dialog = $.hDialog({
            href: "/P2PProjectManage/OrgMatchLookUpView",
            iconCls: 'icon-add',
    ...
    CheckIdear: function () {
        ...
        var Dialog = $.hDialog({
            href: "/P2PProjectManage/ProjectCheckIdearLookUpView",
            iconCls: 'icon-add',
            title: "审核意见",
            width: $(window).width() - 40,
            height: $(window).height() - 50,
