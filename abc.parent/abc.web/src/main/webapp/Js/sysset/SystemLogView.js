...
var MyDepTree = {
    Init: function () {
        ...
        var nodes = [
            ...
            { id: 1, href: "/sysset/LoginLogListView", pId: 0, name: "用户登录日志" },
            { id:2,href: "/sysset/LogSystemErrorView", pId: 0, name: "系统错误日志" },
            { id:3,href: "/sysset/OperateLogListView", pId: 0, name: "数据操作日志" },
        ];
        MyDepTree.zTreeClick(null, "LoginLogListView",nodes[0]);
