(function(window, $, undefined) {
	...
	$.elastislide.prototype = {
		...
		_setDim: function(elW) {
			...
			}).children('img').css({ height:this.options.imageH,width:this.options.imageW });
		...
		_initEvents: function() {
			...
			$(this.$items).hover(function(){
				$(this).find('a').css({ borderColor:'red' });
			},function(){
				$(this).find('a').css({ borderColor:'#000' });
			}).click(function(){
					$(".es-carousel li a").removeClass("borderRed");
					$(this).find('a').addClass("borderRed");

					$(".imgImage img").attr("src", $(this).find('img').attr("src"));
			})
