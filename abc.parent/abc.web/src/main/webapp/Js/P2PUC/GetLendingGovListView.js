...
var MyActionForLendingGov = {
    ...
    Init: function () {
        $("#LendingGovListGrid").datagrid({
            method: "GET",
            url: "/Demo/Json/P2POrgMaintainList.json",
            ...
            { field: "org_no", title: "组织机构代码", width: 150, align: "center" },
            { field: "org_money", title: "资产总额", width: 150, align: "center" },
            { field: "org_contractor", title: "联系人", width: 150, align: "center" },
            { field: "guar_org", title: "担保机构", width: 150, align: "center" },
            { field: "org_contractor_phone", title: "联系电话", width: 150, align: "center" },
            { field: "org_email", title: "公司邮箱", width: 150, align: "center" },
            { field: "cust_major", title: "客户经理", width: 150, align: "center" },
            { field: "org_address", title: "所属地区", width: 150, align: "center" },
            ]],
            pagination: true,
