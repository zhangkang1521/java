...
var MyAction = {
    Init: function() {
        $("#reportGrid").datagrid({
            method: "Get",
            url: "/reportAnalysis/json/investorsReportView.json",
            ...
            columns: [[
               ...
               { field: "pay_interest", title: "应收利息", width: 150, align: "right" },
               { field: "collect_interest", title: "已收利息", width: 150, align: "right" },
               { field: "collect_capital", title: "已收本金", width: 150, align: "right" },
    ...
    Export: function () {
    	$('#searchForm1').attr("action","/reportAnalysis/json/investorsReportExcel.json");
		$('#searchForm1').submit();
