...
/**
 * 个人联系方式
 * @author RJQ 2014/11/13 18:17.
 */
public class UserContactDO {
    /**
     * 主键
     * abc_user_contact.uc_id
     */
    private Integer ucId;

    /**
     * 用户ID
     * abc_user_contact.uc_userid
     */
    private Integer ucUserId;

    /**
     * 手机号码
     * abc_user_contact.uc_phone
     */
    private String ucPhone;

    /**
     * 居住地电话
     * abc_user_contact.uc_home_phone
     */
    private String ucHomePhone;

    /**
     * 居住所在省市
     * abc_user_contact.uc_city
     */
    private String ucCity;

    /**
     * 居住地邮编
     * abc_user_contact.uc_post
     */
    private String ucPost;

    /**
     * 现居住地址
     * abc_user_contact.uc_address
     */
    ...
    /**
     * 第三联系人姓名
     * abc_user_contact.uc_third_contact_name
     */
    ...
    /**
     * MSN
     * abc_user_contact.uc_msn
     */
    private String ucMsn;

    /**
     * QQ
     * abc_user_contact.uc_qq
     */
    private String ucQq;
    ...
    public void setUcSecondContactName(String ucSecondContactName) {
        this.ucSecondContactName = ucSecondContactName;
    }
    ...
    public void setUcSecondContactRelationship(String ucSecondContactRelationship) {
        this.ucSecondContactRelationship = ucSecondContactRelationship;
    }
    ...
    public void setUcSecondContactPhone(String ucSecondContactPhone) {
        this.ucSecondContactPhone = ucSecondContactPhone;
    }
    ...
    public void setUcThirdContactName(String ucThirdContactName) {
        this.ucThirdContactName = ucThirdContactName;
    }
    ...
    public void setUcThirdContactRelationship(String ucThirdContactRelationship) {
        this.ucThirdContactRelationship = ucThirdContactRelationship;
    }
    ...
    public void setUcThirdContactPhone(String ucThirdContactPhone) {
        this.ucThirdContactPhone = ucThirdContactPhone;
    }
    ...
    public void setUcFourthContactName(String ucFourthContactName) {
        this.ucFourthContactName = ucFourthContactName;
    }
    ...
    public void setUcFourthContactRelationship(String ucFourthContactRelationship) {
        this.ucFourthContactRelationship = ucFourthContactRelationship;
    }
    ...
    public void setUcFourthContactPhone(String ucFourthContactPhone) {
        this.ucFourthContactPhone = ucFourthContactPhone;
    }
