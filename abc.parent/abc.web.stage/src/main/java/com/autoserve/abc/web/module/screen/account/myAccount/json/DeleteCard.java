...
public class DeleteCard {
	...
	private HttpServletRequest request;
	 public  BaseResult execute(Context context, ParameterParser params,Navigator nav) {
		//登录URL
		...
		if(bankid!=null&&!"".equals(bankid)){
			PlainResult<BankInfoDO> checkUserResult = bankinfoservice.queryListBankInfoById(Integer.valueOf(bankid));
				if(checkUserResult.isSuccess()&&checkUserResult.getData()!=null){
