...
public class LoginCookieTokenManager {
     ...
     * cookie中标志用户ID的关键字
     */
    public static final String  KEY_LOGIN_COOKIE_USER_ID         = "abcUserId";

    /**
     * cookie中标志用户登录状态实效时间戳的关键字
     */
    public static final String  KEY_LOGIN_COOKIE_EXPIRE_TIMESTAP = "abcUserExpire";

    /**
     * cookie中标志用户登录状态的签名关键字
     */
    public static final String  KEY_LOGIN_COOKIE_SIGN_TOKEN      = "abcUserToken";
    ...
    public static Integer checkLoginTokens(CookieParser cookieParser) {
        ...
        if (StringUtil.isBlank(signToken)) {
            return null;
     ...
     * 设置用户登录的cookie
     */
    public static void addLoginUserCookies(final int userId, final int maxAgeMills, final TurbineRunDataInternal rundata) {
        final HttpServletRequest request = rundata.getRequest();
        final HttpServletResponse response = rundata.getResponse();
     ...
     * 设置用户登录的cookie
     */
    public static void removeLoginUserCookies(final TurbineRunDataInternal rundata) {
        addLoginUserCookies(0, 0, rundata);
    }
