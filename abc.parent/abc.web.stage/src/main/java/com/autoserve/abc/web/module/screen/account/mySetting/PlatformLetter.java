	...
	public void execute(Context context,Navigator nav, ParameterParser params) {
	     ...
	     if(user!=null)
	     {
			 ...
			 for (SysMessageInfoDO sysMessageInfoDO : messageInfoDOList)
			{
				 ...
				 vo.setSysUserName(sysMessageInfoDO.getSysUserName());
			...
			for(int i=0;i<messageInfoDOList.size();i++)
			{
			 ...
			 //分页处理
			  Pagebean<SysMessageInfoVO> pagebean =new Pagebean<SysMessageInfoVO>(currentPage, pageResult.getPageSize(), messageInfoVOList2, pageResult.getTotalCount());
