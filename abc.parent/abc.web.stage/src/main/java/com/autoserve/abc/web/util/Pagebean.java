...
public class Pagebean<T> {
	...
	public Pagebean(int currentPage, int pageSize, List<T> recordList, int recordCount) {
		Calculation(currentPage,pageSize,recordList,recordCount);
	}
	...
	//计算
	public void Calculation(int currentPage, int pageSize, List<T> recordList, int recordCount){
		if(recordCount==0)
		{
			beginPageIndex=0;
			endPageIndex=0;
		...
		// 计算 pageCount
		pageCount = (recordCount + this.pageSize - 1) / this.pageSize;
