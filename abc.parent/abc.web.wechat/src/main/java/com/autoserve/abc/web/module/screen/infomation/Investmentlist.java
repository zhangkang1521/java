...
public class Investmentlist
{
    ...
    public void execute(Context context, ParameterParser params) {
    	...
    	//投资风云榜
    	PageResult<InvestDO> billboard=investQueryService.investmentList(pageCondition);
    	...
    	Pagebean<BillboardVO>  pagebean = new Pagebean<BillboardVO>(currentPage,pageSize,listBillboardVO,billboard.getTotalCount());
