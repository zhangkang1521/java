...
public class MyCredits {
    ...
    public void execute(Context context, ParameterParser params, Navigator nav) {
        ...
        Pagebean<ScoreHistoryWithValueDO> pagebean = new Pagebean<ScoreHistoryWithValueDO>(currentPage, pageSize,
                result.getData(), result.getTotalCount());
        //获取用户积分兑换记录
        ScoreUsageRecordDO scoreusagerecord = new ScoreUsageRecordDO();
        scoreusagerecord.setSurUserId(user.getUserId());
