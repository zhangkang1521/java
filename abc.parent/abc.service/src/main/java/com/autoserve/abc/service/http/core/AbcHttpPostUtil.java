 ...
 */
public class AbcHttpPostUtil {
    private static final Logger log = LoggerFactory.getLogger(AbcHttpPostUtil.class);
    ...
    public static PlainResult<String> execute(final String requestUri, final Map<String, String> params,
        ...
        CloseableHttpClient httpclient = AbcHttpClientFactory.getCloseableHttpClient();
