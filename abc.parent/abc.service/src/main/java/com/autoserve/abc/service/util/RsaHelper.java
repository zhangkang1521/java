...
public class RsaHelper {
     ...
     * RSA 数据签名验证
     * 
     * @param signature （RSA签名数据（base64编码）
     * @param data （待验证的数据原文）
    ...
    /**
  	...
  	public String  getChkValue(String value){
  		...
  		try {
  			...
  			//第二种签名方式,汇付接口建议用第二种
  				String merId=SystemGetPropeties.getChinaPnrString("MerId");
  				String keyUrl=SystemGetPropeties.getSysPath()+SystemGetPropeties.getChinaPnrString("MerKeyFile");
	...
	public Boolean  checkSignMsg(String msgData,String chkValue){ 
		 ...
		 SecureLink secureLink=new SecureLink();
		 String keyUrl=SystemGetPropeties.getSysPath()+SystemGetPropeties.getChinaPnrString("PgKeyFile");
		 System.out.println(keyUrl+"=keyUrl");
