...
public class FundApply {
    ...
    public FundPayType getFaPayType() {
        return faPayType;
    }

    public void setFaPayType(FundPayType faPayType) {
    ...
    public FundState getFaFundState() {
        return faFundState;
    }

    public void setFaFundState(FundState faFundState) {
