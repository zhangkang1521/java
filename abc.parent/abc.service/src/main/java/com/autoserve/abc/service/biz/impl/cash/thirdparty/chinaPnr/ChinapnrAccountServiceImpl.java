...
@Service
public class ChinapnrAccountServiceImpl implements AccountInfoService {

    private static final Logger logger = LoggerFactory.getLogger(ChinapnrAccountServiceImpl.class);
    @Resource
