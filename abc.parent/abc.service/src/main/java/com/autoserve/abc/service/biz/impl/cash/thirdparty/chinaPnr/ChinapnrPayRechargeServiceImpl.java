...
import com.autoserve.abc.service.biz.impl.cash.thirdparty.doublemoney.DmPayRechargeServiceImpl;
...
@Service
public class ChinapnrPayRechargeServiceImpl implements RechargeService {
	...
	@Override
	public PlainResult<DealReturn> recharge(Integer userId, UserType type,
			BigDecimal moneyAmount, Map<String, String> map) {
	...
	@Override
	public PageResult<TocashRecordJDO> queryUserRecharge(
	...
	@Override
	public PageResult<TocashRecordJDO> queryEmpRecharge(
			TocashRecordJDO tocashRecordJDO, PageCondition pageCondition,
			String startDate, String endDate) {
		PageResult<TocashRecordJDO> result = new PageResult<TocashRecordJDO>(pageCondition);
	...
	public PageResult<RechargeRecordDO> queryRechargeRecordByparam(
		 ...
		 if (count > 0) {
	            List<RechargeRecordDO> list = this.rechargeDao.rechargeRecordByparam(rechargeRecordDO, pageCondition, startDate,
	                    endDate);
